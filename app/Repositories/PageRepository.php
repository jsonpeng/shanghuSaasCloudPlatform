...
class PageRepository extends BaseRepository
{
    ...
    public function getCachePage($id){
        return Cache::remember('zcjy_page_'.$id, Config::get('web.cachetime'), function() use ($id) {
            try {
                return Page::find($id);
            } catch (Exception $e) {
                return;
    ...
    public function getCachePageBySlug($slug){
        return Cache::remember('zcjy_page_'.$slug, Config::get('web.cachetime'), function() use ($slug) {
            try {
